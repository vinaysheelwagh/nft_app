...
import { CircleButton, RectButton, SubInfo, FocussedStatusBar, DetailsDesc, DetailsBid } from "../components";
...
const Details = ({ route, navigation }) => {
  ...
  return (
    <SafeAreaView style={{ flex: 1 }}>
      <FocussedStatusBar barStyle="dark-content" backgroundColor="transparent" translucent={true} />
      <View
        style={{
          width: "100%",
          position: "absolute",
